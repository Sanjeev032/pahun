            ...
            <div className="flex items-center gap-8">
                ...
                <div className="flex items-center gap-4 group cursor-pointer">
                    <div className="text-right">
                        <p className="text-[10px] font-bold tracking-widest uppercase">Admin. Arjun</p>
                        <p className="text-[8px] text-luxury-gold tracking-widest uppercase font-bold">Director</p>
                    </div>
