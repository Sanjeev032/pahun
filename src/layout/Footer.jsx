            ...
            <div className="container-custom">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24 mb-24">
                    <div className="col-span-1 md:col-span-2">
                        <h2 className="text-3xl tracking-extra font-light mb-8">PAHUNN</h2>
                        ...
                        <div className="flex gap-8">
                            <a href="#" className="text-luxury-gray-medium hover:text-luxury-gold transition-all"><Instagram size={20} strokeWidth={1} /></a>
                            <a href="#" className="text-luxury-gray-medium hover:text-luxury-gold transition-all"><Twitter size={20} strokeWidth={1} /></a>
                            <a href="#" className="text-luxury-gray-medium hover:text-luxury-gold transition-all"><Facebook size={20} strokeWidth={1} /></a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-4 text-sm text-luxury-gray-medium font-light">
                            ...
                            <li><Link to="/atelier" className="hover:text-white transition-all">Atelier</Link></li>
                            <li><Link to="/sustainability" className="hover:text-white transition-all">Sustainability</Link></li>
                    ...
                    <div>
                        ...
                        <p className="text-xs text-luxury-gray-medium mb-8 uppercase tracking-widest leading-loose">
                            Join the Pahunn circle for early access and editorial stories.
                        </p>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-luxury-gray-dark text-[9px] tracking-[.4em] uppercase text-luxury-gray-medium">
                    <p>&copy; 2026 Pahunn Couture. All Rights Reserved.</p>
